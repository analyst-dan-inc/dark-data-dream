      ...
      >
        <div className="glass-panel relative flex h-full flex-col overflow-hidden rounded-[27px]">
          ...
          <div className="relative h-[10.5rem] w-full overflow-hidden border-b border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent sm:h-[12rem] lg:h-[14rem] xl:h-[15.5rem]">
            ...
            <div className="pointer-events-none absolute bottom-2 left-4 right-4 z-10 flex items-center justify-between text-[9px] uppercase tracking-[0.3em] text-muted-foreground/70">
