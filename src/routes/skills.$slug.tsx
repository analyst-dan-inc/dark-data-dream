            ...
            <div className="glass-panel group relative flex h-full min-h-[360px] flex-col overflow-hidden rounded-[27px]">
              {skill.image ? (
                <>
                  ...
                  <div className="pointer-events-none absolute inset-0 grid-bg opacity-40 transition-opacity duration-700 group-hover:opacity-10" />
                  ...
                  {/* hover hint */}
                  <div className="pointer-events-none absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full border border-white/15 bg-background/40 px-3 py-1 text-[10px] uppercase tracking-[0.3em] text-foreground/70 backdrop-blur-md transition-all duration-500 group-hover:translate-y-2 group-hover:opacity-0">
                    Hover to reveal
                  </div>
                </>
              ) : (
